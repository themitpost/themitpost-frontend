							...
							<ul className="sidebar-items">
								...
								<li className={`sidebar-item ${openStates[1] ? "ddown-visible" : ""}`}>
									...
									<ul className="sidebar-ddown">
										...
										<li className="sidebar-link">The Board of 2025-26</li>
										<li className="sidebar-link">From the Editor's Desk</li>
									</ul>
								</li>
								<li className={`sidebar-item ${openStates[2] ? "ddown-visible" : ""}`}>
									...
									<ul className="sidebar-ddown">
										<li className="sidebar-link">Academic Calendar 25-26</li>
										<li className="sidebar-link">Academic Handbook 25-26</li>
										<li className="sidebar-link">Manipal OSF</li>
										<li className="sidebar-link">Library Portal</li>
										<li className="sidebar-link">MIT Website</li>
									</ul>
								</li>
